...
ls -l data/WIDERFace/WIDER_train/Annotations | grep "^-" | awk '{print $9}' | cut -d '.' -f 1 > data/WIDERFace/WIDER_train/train_WIDER.txt > /dev/null
ls -l data/WIDERFace/WIDER_val/Annotations | grep "^-" | awk '{print $9}' | cut -d '.' -f 1 > data/WIDERFace/WIDER_val/val_WIDER.txt > /dev/null
...
ls -l data/MAFA/MAFA_train/Annotations | grep "^-" | awk '{print $9}' | cut -d '.' -f 1 > data/MAFA/MAFA_train/train_MAFA.txt > /dev/null
ls -l data/MAFA/MAFA_test/Annotations | grep "^-" | awk '{print $9}' | cut -d '.' -f 1 > data/MAFA/MAFA_test/test_MAFA.txt > /dev/null
echo "Finished"